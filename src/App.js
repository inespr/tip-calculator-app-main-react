          ...
          <div className='container'>
            <div className='column'>
                <div className='row'>
                  ...
                  <input type={'number'} placeholder="0" id="bill" onChange={event => setBill(event.target.value)}  min="1" pattern="^[0-9]+"/>
                    <svg stroke="currentColor" className='input-icon' fill="currentColor" strokeWidth={0} viewBox="0 0 16 16"  height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
